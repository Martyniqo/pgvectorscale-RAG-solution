...
relevant_question = "What to do when my account is blocked?"
...
irrelevant_question = "What is the weather in Warsaw?"
...
predicates = client.Predicates("category", "==", "security")
results = vec.search(relevant_question, limit=3, predicates=predicates)


predicates = client.Predicates("category", "==", "security") | client.Predicates(
    "category", "==", "loans"
)
results = vec.search(relevant_question, limit=3, predicates=predicates)
